...
const Review = () => {
  ...
  return (
    <section className="bg-white pb-20">
        <div className="padding-container max-container items-center text-center flex flex-col gap-4 py-10 mt-20">
            <h2 className="text-[28px] font-[600]">It’s the connections between us that power Chipper Cash</h2>
       ...
       <div className="px-20 lg:px-36 py-10">
       ...
       <div className="flex flex-col md:flex-row gap-10 lg:items-center lg:justify-between padding-container max-container">
        {/* Left side */}
            <div className="flex gap-4 flex-col text-purple-10">
                <div>
                    <div className="bg-purple-20 p-[2px] w-8 rounded-full mb-1" />
                    <p className="text-[22px] font-[500] md:max-w-[380px]">Community powered by over 5 million users, and we are just getting started.</p>
                </div>
               <div className="flex gap-16">
                    <div>
                        <h2 className="text-[68px] font-[500]">4.5<span className="text-sm">out of 5</span></h2>
                        <Link href="/" className="flex gap-2 text-black-20 font-[500]">
                            <Image
